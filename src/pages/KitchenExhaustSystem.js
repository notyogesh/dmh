...
const KitchenExhaustSystem = () => {
  return (
    ...
    >
      ...
      Welcome to our kitchen exhaust ducting installation website! We are your
      go-to experts for professional and reliable kitchen exhaust ducting
      installation services. Our team of skilled technicians has years of
      experience in the industry and can provide top-notch solutions for all
      your kitchen ventilation needs. Whether you're a homeowner or a business
      owner, we have the expertise to deliver exceptional results.
      <br />
      <br />
      <Typography variant="h4" sx={{ my: 2 }}>
        Why is Kitchen Exhaust Ducting Installation Important?
      </Typography>
      Proper kitchen exhaust ducting installation is critical for the efficient
      and safe operation of your kitchen ventilation system. A well-designed and
      properly installed ducting system helps to remove grease, smoke, heat, and
      odors from your kitchen, creating a healthy and comfortable environment
      for your family, employees, or customers. It also helps to comply with
      local building codes and regulations, ensuring the safety and well-being
      of your property and those inside
      <br />
      ...
      Our team of experts will assess your kitchen layout and design a
      customized exhaust ducting system that meets local building codes and
      industry standards. We consider factors such as the size of your kitchen,
      the type of cooking equipment you use, and the layout of your building to
      create an efficient and effective ducting system.
      <Typography variant="h4" sx={{ my: 2 }}>
