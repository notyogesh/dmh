...
const TermsAndConditions = () => {
  return (
    <div>
      ...
      letter," "spam," or any other similar solicitation. To impersonate or
      attempt to impersonate the Company, a Company employee, another user, or
      any other person or entity. To engage in any other conduct that restricts
      or inhibits anyone's use or enjoyment of the Services, or which, as
      determined by the Company, may harm the Company or users of the Services,
      or expose them to liability. Intellectual Property The Services and its
      entire contents, features, and functionality (including but not limited to
      all information, software, text, displays, images, video, and audio) are
      ...
      patent, trade secret, and other int
      <br />
      ...
      number of pages of the Services for your own personal, non-commercial use
      and not for further reproduction, publication, or distribution. If we
      provide social media features with certain content, you may take such
      ...
      warranty that the Services will meet your requirements or be available on
      ...
      violation of these Terms or your use
    </div>
  );
};
